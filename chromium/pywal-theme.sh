...
# Script sourced from https://github.com/metafates/ChromiumPywal, with modifications.
# Must load the generated `Pywal` directory manually in Chromium in order to use.
